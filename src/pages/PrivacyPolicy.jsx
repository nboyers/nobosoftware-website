...
const PrivacyPolicy = () => {
  return (
    <div className="privacy-policy-container">
      ...
      <p>
        Your privacy is important to us. This Privacy Policy explains what information our Company ("we" or "us") collects when you use our Service, how we use and share that information, and the choices you have regarding your data...
      </p>
      ...
      <section>
        ...
        <p>The Service is not for users under age 13. If discovered, data submitted by minors will be deleted. Use by minors over 13 should be supervised by a parent or guardian.</p>
      </section>

      <section>
        <h2>International Users</h2>
        <p>By using the Service, you consent to the data practices described in this Privacy Policy. If you do not agree with this Policy, please do not use the Service.</p>
      </section>
